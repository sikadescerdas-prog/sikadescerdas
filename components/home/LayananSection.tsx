    ...
    <section className="relative mt-6 xl:mt-8 overflow-hidden rounded-3xl border border-red-100 bg-gradient-to-br from-red-50 via-white to-rose-100/70 p-5 shadow-2xl backdrop-blur-xl xl:p-6">
      ...
      <div className="mb-6 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500 to-rose-400 text-white shadow-lg">
            <FileText className="h-6 w-6 animate-pulse" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-lg font-bold text-gray-900">Layanan Desa</h3>
        ...
        <Link href="/layanan" className="hidden items-center gap-1 text-sm font-semibold text-red-600 hover:underline md:flex">
          Semua
          <ArrowRight size={15} />
        </Link>
      </div>
        ...
        {services.slice(0, 6).map((service) => {
          ...
          return (
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl border border-white bg-white/80 p-3 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
              {/* ICON */}
