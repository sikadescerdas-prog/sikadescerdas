// components/dashboard/potential/HeaderPotential.tsx
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-5">
            ...
            <div className="flex h-14 w-14 items-center justify-center rounded-xl border border-white/40 bg-white/30 backdrop-blur-sm">
              <FaTree className="h-7 w-7 text-white" />
            </div>

            <div>
              <h2 className="text-2xl font-bold tracking-tight text-white">Potensi Desa</h2>
              <p className="mt-1 text-sm text-white/80">Kelola data potensi dan unggulan desa</p>
            </div>
          </div>
