    ...
    <div className="relative mx-auto mb-3 w-full max-w-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          />
          {isCheckingUsername && (
            <span className="absolute top-9 right-3 animate-pulse text-xs text-slate-400">
              Mengecek...
            </span>
          )}
        </div>
        ...
        <div className="space-y-1">
          <label className="flex cursor-pointer items-start gap-3 text-sm leading-relaxed text-slate-500">
            <input
              ...
              checked={form.agree}
              onChange={handleChange}
              className="mt-1 h-4 w-4 cursor-pointer rounded border-slate-300 accent-[#25C95F]"
            />
            <span>
              Saya setuju dengan{" "}
          ...
          {errors.agree && (
            <span className="block text-xs text-red-500">{errors.agree}</span>
          )}
        </div>
